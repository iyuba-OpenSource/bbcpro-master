...
import com.ai.bbcpro.widget.TextPageSelectTextCallBack;
...
public class TextPage extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private TextPageSelectCallBack tpstc;
...
//        super.onTouchEvent(event);
     ...
     * @param tpstc
     */
    public void setTextpageSelectCallBack(TextPageSelectCallBack tpstc) {
        this.tpstc = tpstc;
    }
