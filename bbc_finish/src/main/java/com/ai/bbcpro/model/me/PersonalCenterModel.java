...
public class PersonalCenterModel implements PersonalCenterContract.PersonalCenterModel {


    @Override
    public Disposable getUserInfo(String url, String platform, String format, String appid, String protocol, String id, String myid, String sign, WxLoginContract.UserCallback callback) {
