...
public class BaseProtocolDef {
    ...
    // xml协议资源请求绝对地址(初始)
    private static String xmlAbsoluteURI_final = "http://apps." + CommonConstant.domain + "/voa/";

    private static String xmlAbsoluteURI_test = "http://apps." + CommonConstant.domain + "/voa/";
