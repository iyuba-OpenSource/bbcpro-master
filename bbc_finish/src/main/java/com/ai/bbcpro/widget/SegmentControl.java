...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadius = ta.getDimensionPixelSize(R.styleable.SegmentControl_cornerRadiuss, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, context.getResources().getDisplayMetrics()));
        mDirection = Direction.values()[ta.getInt(R.styleable.SegmentControl_direction2, 0)];
        ...
        mSelectedTextColor = ta.getColor(R.styleable.SegmentControl_textSelectedColors, 0x79b5fc);
        if (mColors == null) {
            mColors = new ColorStateList(new int[][]{{}}, new int[]{0x79b5fc});
        }
