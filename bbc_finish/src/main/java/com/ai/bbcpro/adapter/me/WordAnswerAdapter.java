 ...
 * 单词页面的
 */
public class WordAnswerAdapter extends BaseQuickAdapter<Word, BaseViewHolder> {
    ...
    public WordAnswerAdapter(int layoutResId, @Nullable List<Word> data) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, Word item) {
        ...
        if (type == 0) {
            ...
            helper.setText(R.id.answer_tv_content, item.getKey());
        } else {
