...
import com.ai.bbcpro.model.login.RegisterSubmitModel;
...
public class RegisterSubmitPresenter extends BasePresenter<RegisterSubmitContract.RegisterSubmitView, RegisterSubmitContract.RegisterSubmitModel>
        implements RegisterSubmitContract.RegisterSubmitPresenter {


    @Override
    protected RegisterSubmitContract.RegisterSubmitModel initModel() {
        return new RegisterSubmitModel();
    }
    ...
    public void register(int protocol, String mobile, String username, String password, String platform, int appid, String app, String format, String sign) {
        ...
        Disposable disposable = model.register(Constant.URL_GET_WX_APPLET_TOKEN, protocol, mobile,
                username, password, platform, appid, app, format, sign, new RegisterSubmitContract.Callback() {
                    @Override
